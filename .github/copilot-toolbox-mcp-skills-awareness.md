...
_Generated: 2026-06-25T11:46:57.083Z_
...
Workspace `mcp.json` _(folder: supply-chain-disrupter-main)_

- **c:\Users\v2garg\Desktop\IISC_Course\capstone_project\supply-chain-disrupter-main\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\v2garg\AppData\Roaming\Code\User\mcp.json** — _File missing_
